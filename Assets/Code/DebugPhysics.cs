...
namespace UnityEngine
{
    public static class DebugPhysics
    {
        ...
        public static bool SphereCast(Vector3 origin, float radius, Vector3 direction,
            out RaycastHit hitInfo, float maxDistance = Mathf.Infinity, int layerMask = 0x1)
        {
            bool sphereHit = Physics.SphereCast(origin, radius, direction, 
        ...
        public static bool Raycast(Vector3 origin, Vector3 direction, out RaycastHit hitInfo, 
            float maxDistance = Mathf.Infinity, int layerMask = 0x1)
        {
